...
if __name__ == '__main__':
    ...
    print ("model loaded")
    location='data/train500.csv'
    path_list=split_test(location,5,500)
    c=0
    percent=60
    returnlist=[]
    for loc in path_list:
              ...
              print ("Accuracy")
              print (count/len(original.keys()))
              print ("Average increment")
              print (str((diff/count)*100)+"%")
    ...
    print (sum(returnlist)/len(returnlist))
